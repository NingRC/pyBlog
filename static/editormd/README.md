...
<script type="text/javascript">
    $(function() {
        var editor = editormd("editor", {
            ...
            path : "editormd.md/lib/"  // Autoload modules mode, codemirror, marked... dependents libs path
        });
    });
</script>
```
...
```javascript
{
    ...
    codeFold             : false,
    autoHeight           : false,
    autoFocus            : true,           // Enable / disable auto focus editormd left input area
    autoCloseTags        : true,
    ...
    tabSize              : 4,
    indentUnit           : 4,
    lineNumbers          : true,           // Display editormd line numbers
    lineWrapping         : true,
    ...
    fontSize             : "13px",
    saveHTMLToTextarea   : false,          // If enable, Editor will create a <textarea name="{editormd-id}-html-code"> tag save HTML code for form post to server-side.
    disabledKeyMaps      : [],
    ...
    previewCodeHighlight : true,           // Enable / disable code highlight of editormd preview area
